...
public class Generator extends TemplateModuleInterpreted2 {
  ...
  public SModuleReference getModuleReference() {
    return PersistenceFacade.getInstance().createModuleReference("8f5e0efa-bc9e-4401-8e2b-326467a6e542(Shapes.generator)");
  }

  @Override
  protected void fillTemplateModels(TemplateModuleInterpreted2.TemplateModels models) {
    models.templates("r:82f891c1-f4a1-4558-97d6-9c24c1510ec2", QueriesGenerated.class);
  }
